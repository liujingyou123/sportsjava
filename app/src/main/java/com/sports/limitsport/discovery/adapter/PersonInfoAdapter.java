...
public class PersonInfoAdapter extends BaseQuickAdapter<DongTaiList, BaseViewHolder> {
    public PersonInfoAdapter(@Nullable List<DongTaiList> data) {
        super(R.layout.adapter_dongtai_person, data);
    }
