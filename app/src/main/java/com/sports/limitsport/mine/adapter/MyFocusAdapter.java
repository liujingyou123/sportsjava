...
public class MyFocusAdapter extends BaseQuickAdapter<FansList, BaseViewHolder> {
    public MyFocusAdapter(@Nullable List<FansList> data) {
    ...
    protected void convert(BaseViewHolder helper, FansList item) {
        ...
        if ("0".equals(item.getStatus())) { //0:他不关注我 1:互相关注
            tvFocus.setText("已关注");
